...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_NPC_t, stringdata) + ofs \
...
const QMetaObject NPC::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_NPC.data,
...
void *NPC::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_NPC.stringdata))
        return static_cast<void*>(const_cast< NPC*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< NPC*>(this));
