...
struct qt_meta_stringdata_Magic_t {
    QByteArrayData data[3];
    char stringdata[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Magic_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Magic_t qt_meta_stringdata_Magic = {
    {
QT_MOC_LITERAL(0, 0, 5), // "Magic"
...
const QMetaObject Magic::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Magic.data,
      qt_meta_data_Magic,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Magic::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Magic.stringdata))
        return static_cast<void*>(const_cast< Magic*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< Magic*>(this));
